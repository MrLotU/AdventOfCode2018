...
public func dayOnePartTwo() -> Int {
    ...
    func getOutput() -> Int {
        for i in inputArray {
            currentOutput += i
            if outputs.contains(currentOutput) {
